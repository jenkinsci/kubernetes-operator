...
[![Gitter](https://badges.gitter.im/jenkinsci/kubernetes-operator.png)(test)]
...
We also have a [gitter]()/[matrix](https://matrix.to/#/#jenkinsci_kubernetes-operator:gitter.im) channel, come to say hi!
